...
export const MODEL_REGISTRY: ModelDef[] = [
  ...
  // --- OpenAI (Direct API) ---
  {
    ...
    supportsVision: true,
    supportsTools: true,
    notes: "Frontier model. Reasoning + coding + agentic workflows.",
  },
  {
    ...
    supportsVision: true,
    supportsTools: true,
    notes: "Maximum capability. Uses more compute for harder problems.",
  },
  {
    ...
    supportsVision: true,
    supportsTools: true,
    notes: "Fast and cheap. Best price/performance for high-volume.",
  },
  {
    id: "openai:o4-mini",
    provider: "openai",
